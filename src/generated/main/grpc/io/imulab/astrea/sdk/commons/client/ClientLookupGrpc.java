...
public final class ClientLookupGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.imulab.astrea.sdk.commons.client.ClientLookupRequest,
      io.imulab.astrea.sdk.commons.client.ClientLookupResponse> getFindMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Find",
      requestType = io.imulab.astrea.sdk.commons.client.ClientLookupRequest.class,
      responseType = io.imulab.astrea.sdk.commons.client.ClientLookupResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.imulab.astrea.sdk.commons.client.ClientLookupRequest,
      io.imulab.astrea.sdk.commons.client.ClientLookupResponse> getFindMethod() {
    io.grpc.MethodDescriptor<io.imulab.astrea.sdk.commons.client.ClientLookupRequest, io.imulab.astrea.sdk.commons.client.ClientLookupResponse> getFindMethod;
      ...
      synchronized (ClientLookupGrpc.class) {
        if ((getFindMethod = ClientLookupGrpc.getFindMethod) == null) {
          ClientLookupGrpc.getFindMethod = getFindMethod = 
              io.grpc.MethodDescriptor.<io.imulab.astrea.sdk.commons.client.ClientLookupRequest, io.imulab.astrea.sdk.commons.client.ClientLookupResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "client.ClientLookup", "Find"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.imulab.astrea.sdk.commons.client.ClientLookupRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.imulab.astrea.sdk.commons.client.ClientLookupResponse.getDefaultInstance()))
  ...
  public static abstract class ClientLookupImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void find(io.imulab.astrea.sdk.commons.client.ClientLookupRequest request,
        io.grpc.stub.StreamObserver<io.imulab.astrea.sdk.commons.client.ClientLookupResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.imulab.astrea.sdk.commons.client.ClientLookupRequest,
                io.imulab.astrea.sdk.commons.client.ClientLookupResponse>(
                  this, METHODID_FIND)))
          .build();
    }
  }
  ...
  public static final class ClientLookupBlockingStub extends io.grpc.stub.AbstractStub<ClientLookupBlockingStub> {
    ...
    /**
     */
    public io.imulab.astrea.sdk.commons.client.ClientLookupResponse find(io.imulab.astrea.sdk.commons.client.ClientLookupRequest request) {
  ...
  public static final class ClientLookupFutureStub extends io.grpc.stub.AbstractStub<ClientLookupFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.imulab.astrea.sdk.commons.client.ClientLookupResponse> find(
        io.imulab.astrea.sdk.commons.client.ClientLookupRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FIND:
          serviceImpl.find((io.imulab.astrea.sdk.commons.client.ClientLookupRequest) request,
              (io.grpc.stub.StreamObserver<io.imulab.astrea.sdk.commons.client.ClientLookupResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ClientLookupBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.imulab.astrea.sdk.commons.client.ClientServiceProto.getDescriptor();
    }
