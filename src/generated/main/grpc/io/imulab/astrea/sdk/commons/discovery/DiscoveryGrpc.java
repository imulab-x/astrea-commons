...
public final class DiscoveryGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest,
      io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse> getGetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Get",
      requestType = io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest.class,
      responseType = io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest,
      io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse> getGetMethod() {
    io.grpc.MethodDescriptor<io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest, io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse> getGetMethod;
    if ((getGetMethod = DiscoveryGrpc.getGetMethod) == null) {
      synchronized (DiscoveryGrpc.class) {
        if ((getGetMethod = DiscoveryGrpc.getGetMethod) == null) {
          DiscoveryGrpc.getGetMethod = getGetMethod = 
              io.grpc.MethodDescriptor.<io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest, io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "discovery.Discovery", "Get"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse.getDefaultInstance()))
  ...
  public static abstract class DiscoveryImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void get(io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest request,
        io.grpc.stub.StreamObserver<io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest,
                io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse>(
                  this, METHODID_GET)))
          .build();
    }
  }
  ...
  public static final class DiscoveryBlockingStub extends io.grpc.stub.AbstractStub<DiscoveryBlockingStub> {
    ...
    /**
     */
    public io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse get(io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest request) {
  ...
  public static final class DiscoveryFutureStub extends io.grpc.stub.AbstractStub<DiscoveryFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse> get(
        io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET:
          serviceImpl.get((io.imulab.astrea.sdk.commons.discovery.DiscoveryRequest) request,
              (io.grpc.stub.StreamObserver<io.imulab.astrea.sdk.commons.discovery.DiscoveryResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class DiscoveryBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.imulab.astrea.sdk.commons.discovery.DiscoveryServiceProto.getDescriptor();
    }
